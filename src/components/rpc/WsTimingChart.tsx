...
import { WsDeltaPoint } from '@/hooks/useWsBlockRace';
...
interface WsTimingChartProps {
  history: Map<string, WsDeltaPoint[]>;
  urls: string[];
}

export function WsTimingChart({ history, urls }: WsTimingChartProps) {
