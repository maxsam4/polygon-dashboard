...
**IMPORTANT: Always check with the user before deploying to production.** Do not auto-deploy after completing a task. Confirm changes are ready and get explicit approval before deploying.
