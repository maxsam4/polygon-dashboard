-- Migration: Add gas_target_pct_avg to continuous aggregates
...
-- Recreate 1-minute aggregate with gas_target_pct_avg
...
-- Recreate 1-hour aggregate with gas_target_pct_avg
