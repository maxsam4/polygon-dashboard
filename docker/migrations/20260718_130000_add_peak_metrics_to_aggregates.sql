-- Migration: Add tps_max and mgas_per_sec_max peak metrics to continuous aggregates
...
-- Recreate 1-minute aggregate with tps_max and mgas_per_sec_max
...
-- Recreate 1-hour aggregate with tps_max and mgas_per_sec_max
