-- Migration: Add gas_limit_sum to continuous aggregates for block limit charts
...
-- Recreate 1-minute aggregate with gas_limit_sum
...
-- Recreate 1-hour aggregate with gas_limit_sum
