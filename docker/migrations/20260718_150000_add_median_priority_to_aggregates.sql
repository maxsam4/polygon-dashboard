-- Migration: Add median_priority_fee_avg to continuous aggregates
-- (block-count-weighted rollup of per-block median priority fee, for /stats)
...
-- Recreate 1-minute aggregate with median_priority_fee_avg
...
-- Recreate 1-hour aggregate with median_priority_fee_avg
